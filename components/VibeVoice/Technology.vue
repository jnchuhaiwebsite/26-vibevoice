    ...
    <section id="technology" class="py-24 px-6">
        <div class="container">
            <div class="grid items-center gap-8 lg:grid-cols-2 lg:gap-16">
                <img src="https://resp.vibevoices.net/vvoice/image/vibevoice.png" loading="lazy"
                    alt="VibeVoice Technology Architecture" class="max-h-full w-full rounded-md object-cover">
                <div class="flex flex-col lg:text-left">
                    <h2 class="mb-6 text-pretty text-3xl font-bold text-white lg:text-4xl">VibeVoice is Powered by
                        Microsoft's VALL-E X Model</h2>
                    <p class="mb-8 max-w-xl text-[#D1D5DB] lg:max-w-none lg:text-lg">Understand the groundbreaking
                        open-source technology that makes this AI Voice Generator, VibeVoice, possible. Discover
                        VibeVoice innovation.</p>
                    <ul class="flex flex-col justify-center gap-y-8">
                        <li class="flex">
                            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
                                class="mr-4 size-6 shrink-0 text-[#A78BFA]" height="1em" width="1em"
                        ...
                        <li class="flex">
                            ...
                            <div>
                                <div class="mb-2 text-base font-semibold text-white">Zero-Shot Capabilities</div>
                                <div class="text-sm font-medium text-[#9CA3AF]">The model's key innovation is its
                                    'in-context learning' enabling synthesis of personalized voices from short audio
                                    prompts with VibeVoice.</div>
                            </div>
                        </li>
                        <li class="flex">
                            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
